---
title: 'Naive VQA: Implementations of a Strong VQA Baseline'
date: 2021-07-17
excerpt: "A Visual Question Answering model implemented in **MindSpore** and **PyTorch**. The model is a reimplementation of the paper *Show, Ask, Attend, and Answer: A Strong Baseline For Visual Question Answering*. It's our final project for course DL4NLP at ZJU.<br/><img style='margin: 3; width: 40%' src='/images/NaiveVQA_image_demo1.jpg'><br/>**Question**: *What color is the girl's necklace?*<br/>**Answer**: 'white'"
permalink: /posts/2020/07/NaiveVQA/
tags:
  - Deep Learning
  - MindSpore
  - PyTorch
...
![](/images/NaiveVQA_image_demo1.jpg)
...
[MindSpore](https://www.mindspore.cn/en) is a new AI framework developed by Huawei.
...
[This repository](https://github.com/vtu81/NaiveVQA) contains a naive VQA model, which is our final project (**mindspore** implementation) for course DL4NLP at ZJU. It's a reimplementation of the paper [Show, Ask, Attend, and Answer: A Strong Baseline For Visual Question Answering](https://arxiv.org/abs/1704.03162).
...
![](/images/NaiveVQA_ms_result_per_question_type.png)

* Per Question Type Accuracy (**PyTorch**)
![](/images/NaiveVQA_pt_result_per_question_type.png)
...
![](/images/NaiveVQA_val_acc1.png)

(a real train of PyTorch implementation)

![](/images/NaiveVQA_val_acc2.png)
